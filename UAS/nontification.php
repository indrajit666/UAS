<ul class="nav navbar-nav">
		...
		<ul class="dropdown-menu">
			...
			<li>
				...
				<ul class="menu">
					...
					<li>
						<a href="#"><i class="fa fa-warning text-yellow"></i> Very Long Description</a>
					</li>
					<li>
	...
	<li class="dropdown user user-menu">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown">
			<?php echo'<img src="data:image/jpeg;base64,'.base64_encode($SPhoto).'" class="user-image" alt="User Image" />'; ?>
			<span class="hidden-xs"><?php echo $SFName; ?></span>
		</a>
		<ul class="dropdown-menu">
			<!-- User Image -->
			<li class="user-header">
				<?php echo'<img src="data:image/jpeg;base64,'.base64_encode($SPhoto).'" class="img-circle" alt="User Image">'; ?>
				<p><?php echo $SUsername; ?> - <?php echo $SAccess; ?><small>Member Since <?php echo $SCreated; ?></small></p>
			</li>
			<!-- Menu Body -->
			<li class="user-body">
				<div class="row">
